''' Papa Yaw Owusu Nti
    ...
    CS 152 B
    Lab 03
    This program computes the density and the thermocline_depth for July 2019
'''
...
def main():
    ''' This function computes the density and the thermocline_depth for July 2019 
    by keeping track of the number of days and writing the computation into a new file  thermo_depths_july.csv'''
    ...
    fout = open("GoldieJuly2019.csv","r")
    fout.readline()
    day= 0
    fp = open("thermo_depths_july.csv","w")
    fp.write("day,depth" + "\n")
